...
//Application Title
define('APP_TITLE', 'Base de Datos - BDF');
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="Estados de cuenta">
        ...
        <div class="card mb-2 fm-upload-wrapper <?php echo fm_get_theme(); ?>">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#urlUploader" class="js-url-upload" data-target="#urlUploader"><i class="fa fa-link"></i> Cargar desde </a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover table-sm <?php echo $tableTheme; ?>" id="main-table">
            ...
            <tr>
                ...
                <th><?php echo lng('Nombre') ?></th>
                <th><?php echo lng('Tamaño') ?></th>
                <th><?php echo lng('Modificado') ?></th>
                <?php if (!FM_IS_WIN && !$hide_Cols): ?>
                    <!--<th><?php //echo lng('Permisos') ?></th>-->
                    <th><?php echo lng('Servidor') ?></th><?php endif; ?>
                <th><?php echo lng('Acciones') ?></th>
            </tr>
            </thead>
            <?php
            ...
            foreach ($folders as $f) {
                ...
                <tr>
                    ...
                    <td class="inline-actions"><?php if (!FM_READONLY): ?>
                            ...
                            <a title="<?php echo lng('Rename')?>" href="#" onclick="rename('<?php echo fm_enc(addslashes(FM_PATH)) ?>', '<?php echo fm_enc(addslashes($f)) ?>');return true;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                ...
                <tr>
                    ...
                    <td class="inline-actions">
                        ...
                        <?php if (!FM_READONLY): ?>
                            ...
                            <a title="<?php echo lng('Rename') ?>" href="#" onclick="rename('<?php echo fm_enc(addslashes(FM_PATH)) ?>', '<?php echo fm_enc(addslashes($f)) ?>');return true;"><i class="fa fa-pencil-square-o"></i></a>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Estados de cuentar<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        <a class="navbar-brand" href="index.php"> <?php echo lng('AppTitle') ?> </a>
...
<script>
    ...
    function rename(e, t) {var n = prompt("Nuevo nombre", t);null !== n && "" !== n && n != t && (window.location.search = "p=" + encodeURIComponent(e) + "&ren=" + encodeURIComponent(t) + "&to=" + encodeURIComponent(n))}
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Administrador de Archivos - ZoomBDF';
    $tr['en']['AppTitle']           = 'Regresar';
    $tr['en']['Login']          = 'Sign in';                $tr['en']['Username']           = 'Usuario';
    $tr['en']['Password']       = 'Password';               $tr['en']['Logout']             = 'Salir';
    $tr['en']['Move']           = 'Mover';                   $tr['en']['Copy']               = 'Copiar';
    $tr['en']['Save']           = 'Guardar';                   $tr['en']['SelectAll']          = 'Seleccionar todo';
    $tr['en']['UnSelectAll']    = 'Deseleccionar todo';           $tr['en']['File']               = 'Archivo';
    $tr['en']['Back']           = 'Atras';                   $tr['en']['Size']               = 'Tamaño';
    $tr['en']['Perms']          = 'Permisos';                  $tr['en']['Modified']           = 'Modificado';
    $tr['en']['Owner']          = 'Servidor';                  $tr['en']['Search']             = 'Buscar';
    $tr['en']['NewItem']        = 'Nueva carpeta';               $tr['en']['Folder']             = 'Carpeta';
    $tr['en']['Delete']         = 'Borrar';                 $tr['en']['Rename']             = 'Renombrar';
    $tr['en']['CopyTo']         = 'Copiar hacia';                $tr['en']['DirectLink']         = 'Enlace directo';
    $tr['en']['UploadingFiles'] = 'Cargar archivos';           $tr['en']['ChangePermissions']  = 'Cambiar permisos';
    $tr['en']['Copying']        = 'Copiando';                $tr['en']['CreateNewItem']      = 'Crear nueva carpeta';
    $tr['en']['Name']           = 'Nombre';                   $tr['en']['AdvancedEditor']     = 'Edición avanzada';
    $tr['en']['RememberMe']     = 'Recuerdalo';            $tr['en']['Actions']            = 'Acciones';
    $tr['en']['Upload']         = 'Cargar';                 $tr['en']['Cancel']             = 'Cancelar';
    $tr['en']['InvertSelection']= 'Invertir selección';       $tr['en']['DestinationFolder']  = 'Carpeta de destino';
    $tr['en']['ItemType']       = 'tipo de archivo';              $tr['en']['ItemName']           = 'Nombre de carpeta';
    $tr['en']['CreateNow']      = 'Crear ahora';             $tr['en']['Download']           = 'Descargar';
    $tr['en']['Open']           = 'Abrir';                   $tr['en']['UnZip']              = 'Descomprimir';
    $tr['en']['UnZipToFolder']  = 'Descomprimir carpeta';        $tr['en']['Edit']               = 'Editar';
    $tr['en']['NormalEditor']   = 'Edición normal';          $tr['en']['BackUp']             = 'Regresar';
    $tr['en']['SourceFolder']   = 'Carpeta de origen';          $tr['en']['Files']              = 'Archivos';
    $tr['en']['Move']           = 'Mover';                   $tr['en']['Change']             = 'Cambiar';
    $tr['en']['Settings']       = 'Configuración';               $tr['en']['Language']           = 'Lenguaje';
    $tr['en']['Folder is empty']    = 'Carpeta vacia';    $tr['en']['PartitionSize']      = 'Tamaño de partición';
    $tr['en']['ErrorReporting'] = 'Reporte de errores';        $tr['en']['ShowHiddenFiles']    = 'Ver archivos ocultos';
    $tr['en']['Full size']      = 'Tamaño total';              $tr['en']['Help']               = 'Ayuda';
    $tr['en']['Free of']        = 'Libre para';                $tr['en']['Preview']            = 'Anterior';
    $tr['en']['Help Documents'] = 'Documentos de ayuda';         $tr['en']['Report Issue']       = 'Reportar problema';
    $tr['en']['Generate']       = 'Generar';               $tr['en']['FullSize']           = 'Tamaño total';
    $tr['en']['FreeOf']         = 'Tamaño total';                $tr['en']['CalculateFolderSize']= 'Calcular tamaño de carpeta';
    $tr['en']['ProcessID']      = 'Procesando ID';             $tr['en']['Created']    = 'Creado';
    $tr['en']['HideColumns']    = 'Esconder columnas';$tr['en']['You are logged in'] = 'Estás conectado';
    $tr['en']['Check Latest Version'] = 'Comprobar la última versión';$tr['en']['Generate new password hash'] = 'Generar nuevo hash de contraseña';
    $tr['en']['Login failed. Invalid username or password'] = 'Error de inicio de sesion. usuario o contraseña invalido';
    $tr['en']['password_hash not supported, Upgrade PHP version'] = 'password_hash no compatible, actualizar la versión de PHP';

    // new - novos

    $tr['en']['Advanced Search']    = 'Busqueda avanzada';    $tr['en']['Error while copying from']    = 'Error al copiar de';
    $tr['en']['Nothing selected']   = 'Nada Seleccionado';   $tr['en']['Paths must be not equal']    = 'Las rutas no deben ser iguales';
    $tr['en']['Renamed from']       = 'Renombrar desde';       $tr['en']['Archive not unpacked']       = 'Archivo no descomprimido';
    $tr['en']['Deleted']            = 'Eliminado';            $tr['en']['Archive not created']        = 'Archivo no creado';
    $tr['en']['Copied from']        = 'Copiando desde';        $tr['en']['Permissions changed']        = 'Permisos cambiados';
    $tr['en']['to']                 = 'para';                 $tr['en']['Saved Successfully']         = 'Guardado correctamente';
    $tr['en']['not found!']         = 'no se encuentra!';         $tr['en']['File Saved Successfully']    = 'Arhcivo guardado correctamente';
    $tr['en']['Archive']            = 'Archivado';            $tr['en']['Permissions not changed']    = 'Permisos no guardados';
    $tr['en']['Select folder']      = 'Seleccionar carpeta';      $tr['en']['Source path not defined']    = 'Ruta de origen no definida';
    $tr['en']['already exists']     = 'ya existe';     $tr['en']['Error while moving from']    = 'Error al mover de';
    $tr['en']['Create archive?']    = '¿Crear archivo?';    $tr['en']['Invalid file or folder name']    = 'Nombre de archivo o carpeta no válido';
    $tr['en']['Archive unpacked']   = 'Archivo descomprimido';   $tr['en']['File extension is not allowed']  = 'La extensión de archivo no está permitida';
    $tr['en']['Root path']          = 'Raiz de directorio';          $tr['en']['Error while renaming from']  = 'Error al cambiar el nombre de';
    $tr['en']['File not found']     = 'No se encuentra archivo';     $tr['en']['Error while deleting items'] = 'Error al eliminar elementos';
    $tr['en']['Invalid characters in file name']                = 'Caracteres no válidos en el nombre del archivo';
    $tr['en']['FILE EXTENSION HAS NOT SUPPORTED']               = 'LA EXTENSIÓN DEL ARCHIVO NO ES COMPATIBLE';
    $tr['en']['Selected files and folder deleted']              = 'Archivos y carpetas seleccionados eliminados';
    $tr['en']['Error while fetching archive info']              = 'Error al obtener información del archivo';
    $tr['en']['Delete selected files and folders?']             = '¿Eliminar archivos y carpetas seleccionados?';
    $tr['en']['Search file in folder and subfolders...']        = 'Buscar archivo en carpeta y subcarpetas..';
    $tr['en']['Access denied. IP restriction applicable']       = 'Acceso denegado. Restricción de IP aplicable';
    $tr['en']['Invalid characters in file or folder name']      = 'Caracteres no válidos en el nombre del archivo o carpeta';
    $tr['en']['Operations with archives are not available']     = 'Las operaciones con archivos no están disponibles.';
    $tr['en']['File or folder with this path already exists']   = 'El archivo o carpeta con esta ruta ya existe';
