                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type=text id="Mercado" name="Mercado" class="form-control" required>

                            <label for="Sub_mercado">Sub Mercado:</Label>
                            <input type=text id="Sub_mercado" name="Sub_mercado" class="form-control" required>

                            <label for="Atributo_categoria">Atributo categoria:</Label>
                            <input type=text id="Atributo_categoria" name="Atributo_categoria" class="form-control" required>
                            ...
                            <input type=text id="Laboratorio_completo" name="Laboratorio_completo" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type=text id="Sun_file" name="Sun_file" class="form-control" required>

                          <label for="Pais">Pais:</Label>
                          <input type=text id="Pais" name="Pais" class="form-control" required>

                          <label for="Mineral">Mineral/No_mineral:</Label>
                          <input type=text id="Mineral" name="Mineral" class="form-control" required>

                          <label for="Tracker">Tracker:</Label>
                          <input type=text id="Tracker" name="Tracker" class="form-control" required>

                          <label for="TrackerD">Tracker Descripcion:</Label>
                          <input type=text id="TrackerD" name="TrackerD" class="form-control" required>
                        </div>
                    </div>
                </div>
                <div class="row">
